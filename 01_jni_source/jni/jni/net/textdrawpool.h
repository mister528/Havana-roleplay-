...
public:
	...
	// Used by CSkinShopOverlay to enumerate currently-shown global
	// textdraws and identify the SELECT/EXIT/arrow buttons by label.
	bool IsSlotUsed(uint16_t wText) const {
