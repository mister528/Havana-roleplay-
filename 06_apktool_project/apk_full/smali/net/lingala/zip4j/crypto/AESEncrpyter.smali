...
.method public constructor <init>([CI)V
    ...
    iput-object v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->counterBlock:[B

    .line 68
    new-array v0, v0, [B

    iput-object v0, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->iv:[B
...
.method private init()V
    ...
    iget-object v2, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->aesKey:[B

    invoke-direct {v1, v2}, Lnet/lingala/zip4j/crypto/engine/AESEngine;-><init>([B)V

    iput-object v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->aesEngine:Lnet/lingala/zip4j/crypto/engine/AESEngine;
    ...
    invoke-direct {v1, v2}, Lnet/lingala/zip4j/crypto/PBKDF2/MacBasedPRF;-><init>(Ljava/lang/String;)V

    iput-object v1, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->mac:Lnet/lingala/zip4j/crypto/PBKDF2/MacBasedPRF;

    .line 105
    iget-object v2, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->macKey:[B

    invoke-virtual {v1, v2}, Lnet/lingala/zip4j/crypto/PBKDF2/MacBasedPRF;->init([B)V
...
.method public encryptData([BII)I
    ...
    iget v3, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->nonce:I

    invoke-static {v2, v3, v4}, Lnet/lingala/zip4j/util/Raw;->prepareBuffAESIVBytes([BII)V

    .line 146
    iget-object v2, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->aesEngine:Lnet/lingala/zip4j/crypto/engine/AESEngine;

    iget-object v3, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->iv:[B

    iget-object v4, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->counterBlock:[B
    ...
    .local v2, "k":I
    :goto_2
    iget v3, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->loopCount:I
    ...
    .line 153
    iget v2, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->nonce:I

    add-int/2addr v2, v1

    iput v2, p0, Lnet/lingala/zip4j/crypto/AESEncrpyter;->nonce:I
